...
public class AdminServiceImpl implements AdminService{
	...
	if(opt.isPresent()) {
		 ...
		 extingDepartment.setDepartmentState(department.getDepartmentCity());
	...
	String result="Call Not Assign To The Operator";
	   ...
	   if(calling!=null && operator!=null) {
		    ...
		    exitingCalling.setOperator(exitingOperator);
		     ...
		     result="Call Id : "+exitingCalling.getCallId()+ " is Assign To The Operator Id : "+exitingOperator.getOperatorId();
	   }
