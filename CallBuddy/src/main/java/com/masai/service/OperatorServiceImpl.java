...
//	
	...
	@Override
	public java.util.List<Customer> findCustomerByName(String name) throws CustomerException {

		
		java.util.List<Customer> customers=customerDao.findByName(name);
		
		
		if(customers==null) {
			
			CustomerException customerException=new CustomerException("This "+name+" Person Is Not  Present In Database Please Give Correct Name");
			throw customerException;
		}
	...
	public Customer findCustomerByEmail(String email) throws CustomerException {
	       ...
	       if(opt.isPresent()) {
	    	   ...
	    	   CustomerException customerException=new CustomerException("Customer Is Not Present By Given Eamil");
