...
import com.masai.model.ProblemType;
...
public class CustomerController {
   ...
   @PutMapping("/problem/{id}/{status}")
	public ResponseEntity<String> reopenProblem(@PathVariable("id") Integer problemId,@PathVariable("status") ProblemStatus ProblemStatus) throws ProblemException {
   ...
   @GetMapping("/problems")
	...
	public ResponseEntity<String> changeCustomerPassword(@PathVariable("userName") String customerUserName,@PathVariable("oldPassword") String oldPassword, @PathVariable("newPassword") String newPassword)
	...
	public ResponseEntity<String> createProblem(@PathVariable("id") Integer customerId,@RequestBody  Problem problem) throws ProblemException, CustomerException{
